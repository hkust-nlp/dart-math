...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'dart_math.data': { 'dart_math.data.QueryDataPoint': ('data.html#querydatapoint', 'dart_math/data.py'),
            ...
            'dart_math.eval': { 'dart_math.eval.EvaluatorBase': ('eval.html#evaluatorbase', 'dart_math/eval.py'),
                                ...
                                'dart_math.eval.EvaluatorMath.could_be_percent': ( 'eval.html#evaluatormath.could_be_percent',
                                                                                   'dart_math/eval.py'),
                                ...
                                'dart_math.eval.EvaluatorMath.index_first_paren_pair': ( 'eval.html#evaluatormath.index_first_paren_pair',
                                                                                         'dart_math/eval.py'),
                                'dart_math.eval.EvaluatorMath.is_num_eq': ('eval.html#evaluatormath.is_num_eq', 'dart_math/eval.py'),
                                'dart_math.eval.EvaluatorMath.is_sym_eq': ('eval.html#evaluatormath.is_sym_eq', 'dart_math/eval.py'),
